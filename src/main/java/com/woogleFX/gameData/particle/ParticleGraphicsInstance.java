...
public class ParticleGraphicsInstance {
    ...
    public boolean update() {
        ...
        if (lifespan == -1) {
            return x < ((WOG1Level) AssetManager.getAsset()).getSceneObject().getAttribute("minx").doubleValue() ||
                    y < ((WOG1Level) AssetManager.getAsset()).getSceneObject().getAttribute("miny").doubleValue() ||
                    x > ((WOG1Level) AssetManager.getAsset()).getSceneObject().getAttribute("maxx").doubleValue() ||
                    y > ((WOG1Level) AssetManager.getAsset()).getSceneObject().getAttribute("maxy").doubleValue();
